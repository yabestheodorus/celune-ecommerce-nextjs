...
const BrandStatement = () => {
  ...
  return (
    <section className='relative w-full h-[70vh] md:h-screen bg-surface-container-low overflow-hidden'>
      ...
      <div className='absolute w-[90%] md:w-[70%] flex flex-col top-16 md:top-56 left-1/2 -translate-x-1/2 z-20'>
        ...
        <p ref={textRef} className='font-playfair text-[2rem] sm:text-[3rem] md:text-[4.2rem] text-terracotta-200 leading-[1.1] text-center'>
      ...
      <Image src='/images/person1.png' alt='Muse Portrait' width={1000} height={1000} className='absolute bottom-0 left-1/2 -translate-x-1/2 w-full md:w-[850px] z-10 object-contain' />
    </section>
  )
}
